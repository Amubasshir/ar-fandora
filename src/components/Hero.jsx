...
//           <h1 className="text-white sm:text-[140px] text-6xl uppercase  font-normal leading-[126px] font-bebas max-w-[606px]">
...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="hero-section flex sm:flex-row">
        <div className="ml-16 mt-7">
          <h1 className="text-white sm:text-[140px] text-6xl uppercase font-normal leading-[126px] font-bebas max-w-[606px] sm:max-w-[100%] sm:text-break-word sm:text-nowrap">
        ...
        <div>
          <img src={secondheroBg} alt="" className="ml-32 md:ml-0" />
        </div>
      </div>
    </section>
  );
